              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-gray-700 text-sm leading-relaxed">
                    The more Tokens you purchase, the more benefits you will unlock within the community. Your next role
                    is <span className="text-[#8b6f47] font-semibold">Smile Builder</span>, where exclusive rewards
                    await.
                  </p>
                </div>
              </div>
